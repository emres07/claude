# Add Security & Exception Handling - Phase 5: Security, Testing & Documentation - CALENDAR APP

## Subtask #1

### Description
Implement Spring Security, authentication, and global exception handling
