# Payment Processing Integration - Database Component

## Overview

Oracle database schema and stored procedures for **Payment Processing Integration**.

- **Database Type**: Oracle 21c/23c
- **Schema Name**: payment_processing_integration
...
sqlplus payment_processing_integration/welcome123@xe
