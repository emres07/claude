# CALENDAR APP - Database Component

## Overview

Oracle database schema and stored procedures for **CALENDAR APP**.

- **Database Type**: Oracle 21c/23c
- **Schema Name**: calendar_app
...
sqlplus calendar_app/welcome123@xe
