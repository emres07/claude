-- Complete CRUD Package for calendarview
CREATE OR REPLACE PACKAGE pkg_calendarview_ops AS
    -- Insert operation
    ...
    END pkg_calendarview_ops;
/

CREATE OR REPLACE PACKAGE BODY pkg_calendarview_ops AS
    ...
    BEGIN
        DELETE FROM calendarview WHERE id = p_id;
    ...
    BEGIN
        ...
        VALUES ('CALENDARVIEW', p_record_id, p_action, SYSTIMESTAMP);
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN
