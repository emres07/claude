-- Complete CRUD Package for role
CREATE OR REPLACE PACKAGE pkg_role_ops AS
    -- Insert operation
...
CREATE OR REPLACE PACKAGE BODY pkg_role_ops AS
    ...
    BEGIN
        ...
        VALUES ('ROLE', p_record_id, p_action, SYSTIMESTAMP);
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN
