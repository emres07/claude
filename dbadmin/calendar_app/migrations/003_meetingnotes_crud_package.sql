-- Complete CRUD Package for meetingnotes
CREATE OR REPLACE PACKAGE pkg_meetingnotes_ops AS
    -- Insert operation
    ...
    END pkg_meetingnotes_ops;
/

CREATE OR REPLACE PACKAGE BODY pkg_meetingnotes_ops AS
    ...
    BEGIN
        DELETE FROM meetingnotes WHERE id = p_id;
    ...
    BEGIN
        ...
        VALUES ('MEETINGNOTES', p_record_id, p_action, SYSTIMESTAMP);
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN
