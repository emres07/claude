-- Complete CRUD Package for notification
CREATE OR REPLACE PACKAGE pkg_notification_ops AS
    -- Insert operation
    ...
    END pkg_notification_ops;
/

CREATE OR REPLACE PACKAGE BODY pkg_notification_ops AS
    ...
    BEGIN
        ...
        VALUES ('NOTIFICATION', p_record_id, p_action, SYSTIMESTAMP);
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN
