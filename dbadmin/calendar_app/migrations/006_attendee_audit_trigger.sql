-- Comprehensive audit trigger for attendee
CREATE OR REPLACE TRIGGER trg_attendee_audit
BEFORE INSERT OR UPDATE OR DELETE ON attendee
FOR EACH ROW
BEGIN
    IF INSERTING THEN
