# User Authentication System - Database Component

## Overview

Oracle database schema and stored procedures for **User Authentication System**.

- **Database Type**: Oracle 21c/23c
- **Schema Name**: user_authentication_system
...
sqlplus user_authentication_system/welcome123@xe
