-- Comprehensive audit trigger for calendarview
CREATE OR REPLACE TRIGGER trg_calendarview_audit
BEFORE INSERT OR UPDATE OR DELETE ON calendarview
FOR EACH ROW
BEGIN
    IF INSERTING THEN
