-- Complete CRUD Package for permission
CREATE OR REPLACE PACKAGE pkg_permission_ops AS
    -- Insert operation
    ...
    END pkg_permission_ops;
/

CREATE OR REPLACE PACKAGE BODY pkg_permission_ops AS
    ...
    BEGIN
        ...
        VALUES ('PERMISSION', p_record_id, p_action, SYSTIMESTAMP);
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN
