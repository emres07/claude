-- Complete CRUD Package for activityreport
CREATE OR REPLACE PACKAGE pkg_activityreport_ops AS
    -- Insert operation
    ...
    END pkg_activityreport_ops;
/

CREATE OR REPLACE PACKAGE BODY pkg_activityreport_ops AS
    ...
    BEGIN
        DELETE FROM activityreport WHERE id = p_id;
    ...
    BEGIN
        ...
        VALUES ('ACTIVITYREPORT', p_record_id, p_action, SYSTIMESTAMP);
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN
