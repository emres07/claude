-- Complete CRUD Package for completionrecord
CREATE OR REPLACE PACKAGE pkg_completionrecord_ops AS
    -- Insert operation
    ...
    END pkg_completionrecord_ops;
/

CREATE OR REPLACE PACKAGE BODY pkg_completionrecord_ops AS
    ...
    BEGIN
        DELETE FROM completionrecord WHERE id = p_id;
    ...
    BEGIN
        ...
        VALUES ('COMPLETIONRECORD', p_record_id, p_action, SYSTIMESTAMP);
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN
