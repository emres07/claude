-- Comprehensive audit trigger for timeslot
CREATE OR REPLACE TRIGGER trg_timeslot_audit
BEFORE INSERT OR UPDATE OR DELETE ON timeslot
FOR EACH ROW
BEGIN
    IF INSERTING THEN
