# TODO LIST APP - Database Component

## Overview

Oracle database schema and stored procedures for **TODO LIST APP**.

- **Database Type**: Oracle 21c/23c
- **Schema Name**: todo_list_app
...
sqlplus todo_list_app/welcome123@xe
